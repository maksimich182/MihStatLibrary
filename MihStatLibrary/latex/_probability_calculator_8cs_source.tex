\doxysection{Probability\+Calculator.\+cs}
\label{_probability_calculator_8cs_source}\index{Calculators/ProbabilityCalculator.cs@{Calculators/ProbabilityCalculator.cs}}
...
\DoxyCodeLine{00011\ \{}
\DoxyCodeLine{00015\ \ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{class\ }ProbabilityCalculator}
\DoxyCodeLine{00016\ \ \ \ \ \{}
\DoxyCodeLine{00017\ \ \ \ \ \ \ \ \ \textcolor{keyword}{private}\ \textcolor{keywordtype}{double}\ \_probabilityOne;}
\DoxyCodeLine{00018\ \ \ \ \ \ \ \ \ \textcolor{keyword}{private}\ \textcolor{keywordtype}{double}\ \_probabilityZero;}
\DoxyCodeLine{00019\ }
\DoxyCodeLine{00023\ \ \ \ \ \ \ \ \ \textcolor{keyword}{public}\ \textcolor{keywordtype}{double}\ ProbabilityOne\ \{\ \textcolor{keyword}{get}\ \{\ \textcolor{keywordflow}{return}\ \_probabilityOne;\ \}\ \}}
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00028\ \ \ \ \ \ \ \ \ \textcolor{keyword}{public}\ \textcolor{keywordtype}{double}\ ProbabilityZero\ \{\ \textcolor{keyword}{get}\ \{\ \textcolor{keywordflow}{return}\ \_probabilityZero;\ \}\ \}}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00033\ \ \ \ \ \ \ \ \ \textcolor{keyword}{public}\ ProbabilityCalculator()}
\DoxyCodeLine{00034\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00035\ \ \ \ \ \ \ \ \ \ \ \ \ \_probabilityOne\ =\ 0;}
\DoxyCodeLine{00036\ \ \ \ \ \ \ \ \ \ \ \ \ \_probabilityZero\ =\ 0;}
\DoxyCodeLine{00037\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00038\ }
...
\DoxyCodeLine{00064\ }
\DoxyCodeLine{00069\ \ \ \ \ \ \ \ \ \textcolor{keyword}{public}\ async\ \textcolor{keywordtype}{void}\ CalculateAsync(\textcolor{keywordtype}{string}\ fileName)}
\DoxyCodeLine{00070\ \ \ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00080\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Task\ calculateBlock\ =\ \textcolor{keyword}{new}\ Task(()\ =>\ \_calculate(blockData));}
...
\DoxyCodeLine{00105\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \_calculate(blockData);}
\DoxyCodeLine{00106\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00107\ }
\DoxyCodeLine{00108\ \ \ \ \ \ \ \ \ \ \ \ \ fsData.Close();}
\DoxyCodeLine{00109\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00110\ }
\DoxyCodeLine{00118\ \ \ \ \ \ \ \ \ \textcolor{keyword}{public}\ \textcolor{keywordtype}{void}\ Calculate(FreqHistogram\ freqHistogram)}
\DoxyCodeLine{00119\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00120\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (freqHistogram.SzShift\ !=\ freqHistogram.Dimension)}
\DoxyCodeLine{00121\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{throw}\ \textcolor{keyword}{new}\ ProbabilityCalculatorException(\textcolor{stringliteral}{"{}Количество\ единиц\ рассчитывается\ только\ при\ совпадении\ размерности\ и\ смещения!"{}});}
\DoxyCodeLine{00122\ }
\DoxyCodeLine{00123\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{long}\ onesCounter\ =\ 0;}
\DoxyCodeLine{00124\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ maxValueForNmOnesInByte\ =\ (Tools.ArNumberOne.Length\ <=\ freqHistogram.Histogram.Length)}
\DoxyCodeLine{00125\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ?\ Tools.ArNumberOne.Length\ :\ freqHistogram.Histogram.Length;}
\DoxyCodeLine{00126\ }
\DoxyCodeLine{00127\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int}\ i\ =\ 0;\ i\ <\ maxValueForNmOnesInByte;\ i++)}
\DoxyCodeLine{00128\ \ \ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00129\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ onesCounter\ +=\ freqHistogram.Histogram[i]\ *\ Tools.ArNumberOne[i];}
\DoxyCodeLine{00130\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00131\ }
\DoxyCodeLine{00132\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int}\ i\ =\ maxValueForNmOnesInByte;\ i\ <\ freqHistogram.Histogram.Length;\ i++)}
\DoxyCodeLine{00133\ \ \ \ \ \ \ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00140\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00141\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ onesCounter\ +=\ freqHistogram.Histogram[i]\ *\ onesInValue;}
\DoxyCodeLine{00142\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00143\ \ \ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00144\ \ \ \ \ \ \ \ \ \ \ \ \ \_probabilityOne\ +=\ (double)onesCounter\ /\ (freqHistogram.NmVectors\ *\ freqHistogram.Dimension);}
\DoxyCodeLine{00145\ \ \ \ \ \ \ \ \ \ \ \ \ \_probabilityZero\ =\ 1\ -\/\ \_probabilityOne;}
\DoxyCodeLine{00146\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00147\ }
\DoxyCodeLine{00152\ \ \ \ \ \ \ \ \ \textcolor{keyword}{private}\ \textcolor{keywordtype}{void}\ \_calculate(BlockData\ blockData)}
\DoxyCodeLine{00153\ \ \ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00158\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00159\ \ \ \ \ \ \ \ \ \ \ \ \ \_probabilityOne\ +=\ (double)count\ /\ (blockData.SzBlockData\ *\ Tools.BITS\_IN\_BYTE);}
\DoxyCodeLine{00160\ \ \ \ \ \ \ \ \ \ \ \ \ \_probabilityZero\ =\ 1\ -\/\ \_probabilityOne;}
\DoxyCodeLine{00161\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00162\ \ \ \ \ \}}
\DoxyCodeLine{00163\ \}}
