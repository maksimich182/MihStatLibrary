...
\DoxyCodeLine{00063\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{throw}\ \textcolor{keyword}{new}\ BitFrequencyCalculatorException(\textcolor{stringliteral}{"{}Смещение\ гистограммы\ должно\ быть\ равно\ размерности!"{}});}
\DoxyCodeLine{00064\ }
